...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ubah Data Petugas</h3>
            <div class="tile-body">
              ...
              <?php 
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="nama" type="text" placeholder="Masukan Nama" value="<?= $data->nama_admin; ?>">
                </div>
                <div class="form-group">
                  <label class="control-label">Username</label>
                  <input class="form-control" name="username" type="text" placeholder="Masukan Username" value="<?= $data->username; ?>">
                </div>
                <div class="form-group">
